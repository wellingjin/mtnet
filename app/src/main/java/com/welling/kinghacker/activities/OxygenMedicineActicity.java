 ...
 */
public class OxygenMedicineActicity extends MTActivity{
    @Override
    protected void onCreate(Bundle instance){
        ...
        for (int i=0;i<40;i++) {
            if (i%8==0) {
                ...
                listData.add(new MedicineAdapterStruct(false,"666","koufu","1990","1day 1 night",90));
            }
        }
        ...
        medicineListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (!listData.get(position).isSeccsion) {
                    gotoActivity(OxygenMedicineDetailActivity.class);
                }
            }
        });
